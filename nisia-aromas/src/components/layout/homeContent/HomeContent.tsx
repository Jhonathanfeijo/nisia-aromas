...
const HomeContent = () => {
    return (<div className="h-full w-full text-secondary flex flex-col items-center sm:items-start">
        <div className="w-max text-left my-5 md:my-10">
            <h1 className="text-4xl">Bem vinda, Nísia!</h1>
        ...
        <main className="select-none flex flex-row flex-wrap w-full justify-center sm:justify-start items-center sm:items-start gap-2 sm:gap-5 md:gap-8">
            <div className="pedidos p-4 shadow-lg drop-shadow bg-primary rounded text-white my-5 flex flex-col hover:scale-[1.1] hover:ml-5 w-[270px] h-[150px] max-w-full duration-300 justify-between">
                <h2 className="text-2xl font-medium">Pedidos</h2>
                <AlertMainItem message="Há pedidos próximos" />
            ...
            <div className="clientes p-4 shadow-lg drop-shadow bg-primary rounded text-white my-5 flex flex-col hover:scale-[1.1] hover:ml-5 w-[270px] h-[150px] max-w-full duration-300 justify-between">
            ...
            <div className="estoques p-4 shadow-lg drop-shadow bg-primary rounded text-white my-5 flex flex-col hover:scale-[1.1] hover:ml-5 w-[270px] h-[150px] max-w-full duration-300 justify-between">
